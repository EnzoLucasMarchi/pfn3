export const Today = ({ setMod, data, ok, err, ops, tcfn, df }) => {
    ...
    return (
        <div className="h-full flex flex-col items-center gap-2 px-2">
            <div className="w-full h-[10%] flex justify-between">
                <button className="bg-bggray w-[50%] h-6 text-xs" 
                onClick={() => setMod(true)}>Search for Places</button>
                <button className="bg-bggray w-6 h-6 rounded-full flex justify-center items-center" 
            ...
            <div className="w-full h-[90%] flex flex-col items-center justify-center py-2 gap-4">
                ...
                <span className="w-1/3 flex items-center justify-center text-wordgray text-xl">°C</span>
                </p>
                <div className="w-full flex flex-col items-center justify-center gap-4">
                <p className="text-lg text-wordgray">{desc}</p>
                <p className="text-wordgray text-xs w-full flex items-center justify-center">Today  -  {date}</p>
                <p className="text-wordgray flex text-xs">
